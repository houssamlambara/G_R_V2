...
?>
  ...
  <nav class="bg-orange-300 dark:bg-black">
    ...
    <div class="mx-auto max-w-md bg-gray-200 p-8 rounded-lg shadow-lg">
      ...
      <div>
        <button type="submit" name="login" class="w-full bg-orange-500 text-white py-3 rounded-lg font-semibold hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-500">Se connecter et continuer</button>
        </div>
