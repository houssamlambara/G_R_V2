...
<section class="container mx-auto text-center mt-12" id="activities">
  ...
  <div class="flex justify-center mt-8 mb-8">
    <a href="./activities.php" class="w-full md:w-auto bg-orange-500 text-white py-4 px-8 rounded-lg font-semibold hover:bg-gradient-to-l hover:bg-orange-600 transition duration-300 text-center block">Réserver Une Activité</a>
  </div>
</section>
